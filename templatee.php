...
function logData($data) {
    $logFile = $_SERVER['DOCUMENT_ROOT']."/log.txt"; // Путь к файлу лога
    $timestamp = date("Y-m-d H:i:s");
    $logMessage = "[$timestamp] " . print_r($data, true) . "\n"; // Добавляем временную метку
    file_put_contents($logFile, $logMessage, FILE_APPEND); // Записываем данные в файл
}
